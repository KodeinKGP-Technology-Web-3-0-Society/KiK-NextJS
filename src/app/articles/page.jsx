        ...
        <div key={index} className="">
            ...
            >
                ...
                <div className="w-[65%] ml-[10px] flex flex-col justify-center gap-[10px] !px-2">
                    <p className="absolute top-[15px] !text-[#11e3fb] text-[13px] leading-[22px] font-['Poppins'] font-semibold not-italic z-10 max-[1300px]:text-[15px] max-[800px]:text-[17px] max-[800px]:top-[230px] max-[550px]:text-[13px] max-[550px]:top-[200px]">
                        {info.pubDate}
                    </p>
