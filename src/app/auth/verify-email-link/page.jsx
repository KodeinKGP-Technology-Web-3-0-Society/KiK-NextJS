...
const VerifyEmailLinkPage = () => {
    ...
    const handleMagicLinkSignIn = async () => {
      if (isSignInWithEmailLink(auth, window.location.href)) {
        ...
        try {
          ...
          setTimeout(() => router.push("/dekodeX"), 1500);
        } catch (error) {
  ...
  // fallback input email submission
...
<div className="text-center">
                ...
                <p className="text-slate-400 mb-6 text-sm">
                  You can go back to problem arena
                </p>
<Link
  href="/dekodeX"
  className="w-full block text-center cursor-pointer rounded-lg bg-cyan-400 py-2 font-semibold text-black transition duration-200 hover:bg-cyan-300"
>
  Go to deKodex
</Link>
              </div>
