...
export default function LabTheory() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[rgb(1,1,27)] p-5 font-['Arial']">
      ...
      >
        {/* Question Image */}
        <div className="quesimg mb-4 hidden h-[300px] w-[90%] lg:block">
          <div className="qimg mx-auto h-full w-[500px] overflow-hidden rounded-lg shadow-[rgba(0,0,0,0.15)_1.95px_1.95px_2.6px]">
            <Image
              src={QuestionImg}
              alt="Question mark"
